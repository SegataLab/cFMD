...
- [https://github.com/SegataLab/cFMD/blob/main/cFMD_metadata.tsv](**cFMD_metadata**): metadata information, in addition to statistics about reconstructed MAGs at sample level. The table has samples as row indices and type of information as column headers. These includes:
...
- [https://github.com/SegataLab/cFMD/blob/main/cFMD_metadata_dictionary.tsv](**cFMD_metadata_dictionary**): description of the syntactic rules to define the metadata fields of the above file "cFMD_metadata"
...
- [https://github.com/SegataLab/cFMD/blob/main/cFMD_mags_list.tsv](**cFMD_mags_list**): the list of the reconstructed MAGs with information in terms of:
  - sample origin,
...
- [https://github.com/SegataLab/cFMD/blob/main/cFMD_sgbs_prokaryotic.tsv](**cFMD_sgbs_prokaryotic**): for each prokaryotic food SGB (i.e., having at least one MAG reconstructed from food) information in terms of:
...
- [https://github.com/SegataLab/cFMD/blob/main/cFMD_sgbs_eukaryotic.tsv](**cFMD_sgbs_eukaryotic**): as the file "cFMD_sgbs_prokaryotic", but referred to eukaryotic SGBs.

- [https://github.com/SegataLab/cFMD/blob/main/cFMD_datasets.tsv](**cFMD_taxonomic_profiles**): taxonomic profiles with samples as row indices, basic metadata are column headers, and values are espressed in relative abundances (%).
